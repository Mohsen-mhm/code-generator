...
abstract class BaseGenerator
{
    ...
    protected function getPath($type)
    {
        ...
        switch ($type) {
            case 'models':
                return $config['models'] ?? $basePath . '/app/Models';
            case 'controllers':
                return $config['controllers'] ?? $basePath . '/app/Http/Controllers';
            case 'requests':
                return $config['requests'] ?? $basePath . '/app/Http/Requests';
            case 'resources':
                return $config['resources'] ?? $basePath . '/app/Http/Resources';
            case 'factories':
                return $config['factories'] ?? $basePath . '/database/factories';
            case 'seeders':
                return $config['seeders'] ?? $basePath . '/database/seeders';
            case 'migrations':
                return $config['migrations'] ?? $basePath . '/database/migrations';
            case 'tests':
                return $config['tests'] ?? $basePath . '/tests/Feature';
            case 'views':
                return $config['views'] ?? $basePath . '/resources/views';
            default:
                return $basePath . '/app';
        }
    }
